...
{
    public partial class _AuditorView : System.Web.UI.Page
    {
                ...
                if (!String.IsNullOrEmpty(StatusID))
                {
                    ...
                    switch (StatusID)
                    {
                        case "1":
                            ...
                            btn.Text = "StartAudit";
                            btn.ClientSideEvents.Click = String.Format("function(s, e) {{ StartAudit_Click(s, e, '{0}', '{1}'); }}", values[0], container.VisibleIndex);
                            break;
                        case "2":
